---
title: "Edit command"
description: "Update a saved command's script, target, concurrency, restart policy, and quick action."
---
...
<Columns cols={2}>
  ...
  <Card title="Target scope" icon="crosshairs">
    Any agent home, a specific agent home, any worktree, or a worktree in one or more selected repositories.
  </Card>
...
| Target scope or repository allow-list | Applies to the next launch; runs already placed on an agent stay there |
...
For **Worktree in selected repositories**, the editor requires at least one repository before you can save. If a repository is deleted later and that deletion removes the command's final assignment, the command does not widen automatically. It remains eligible on no worktrees until you edit it and select a repository or choose **Any worktree**.
