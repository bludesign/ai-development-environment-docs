...
The name, description, script, target kind, concurrency mode, restart policy, restart limit, and notification setting captured when the run started, with **Copy** for the script.
