...
Click **Edit** to change the name, description, or assigned repositories. You must keep at least one repository assigned. Check agents under **Agents** to narrow the repository list to the repositories checked out on them; the filter changes only what the list shows, never what is assigned.
