...
Below the picker, **Latest repository build** shows the newest build across every worktree and agent for that repository, regardless of status or active-agent selection. Open its details or choose **Rebuild** from an **Out of date** badge. The native app provides the same repository cards on app details.
