...
<Steps>
  <Step title="Upload files" icon="upload">
    Under **Write or override**, upload binary or text files. Edit each destination to the exact repository-relative path you want. The editor shows the byte size and SHA-256 digest.
  </Step>
