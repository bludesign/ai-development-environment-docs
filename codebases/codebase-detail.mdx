...
While a Git operation is running, the page shows which kind is in flight and blocks conflicting actions until it completes.
...
<Steps>
  <Step title="Preview" icon="eye">
    **Preview** loads the stash's patch inline. Patches are truncated at 256 KiB, and a stash with no text patch says so.
  </Step>
