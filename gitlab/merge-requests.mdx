...
<Frame>
  <img className="block dark:hidden" src="/images/light/gitlab-merge-request-detail.png" alt="GitLab merge request details page in light theme" />
  <img className="hidden dark:block" src="/images/dark/gitlab-merge-request-detail.png" alt="GitLab merge request details page in dark theme" />
</Frame>
