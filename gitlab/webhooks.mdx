...
The `/gitlab/webhooks` page records the event, project, action, outcome, timestamps, and sanitized error. Invalid signatures are rejected before event processing.
