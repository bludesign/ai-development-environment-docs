...
<Frame>
  <img className="block dark:hidden" src="/images/light/gitlab-settings.png" alt="Managed GitLab projects in Settings in light theme" />
  <img className="hidden dark:block" src="/images/dark/gitlab-settings.png" alt="Managed GitLab projects in Settings in dark theme" />
</Frame>
