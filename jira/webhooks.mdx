...
<Steps>
  <Step title="Check the webhook URL">
    The card fills in this server's address. Edit it if Jira reaches the server somewhere else. The URL must use publicly trusted HTTPS; HTTP, private, and loopback addresses are rejected before registration.
  </Step>
