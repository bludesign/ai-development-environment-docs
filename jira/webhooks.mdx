...
- Review each delivery's **Received** time, **Event**, **Issue**, and **Outcome** (received, processed, ignored, or error).
- For `jira:issue_updated` deliveries, review each changed field and its before and after values under **Details**.
- New deliveries appear at the top of the first page without a refresh.
