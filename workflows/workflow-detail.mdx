...
<Columns cols={2}>
  ...
  <Card title="Worktree reservation" icon="lock">
    **Enabled** means a top-level run waits for earlier work, then reserves its worktree until it finishes, holding back other workflows, Plans, and Sessions. **Disabled** leaves worktree admission to the individual Plan and Session lanes.
  </Card>
</Columns>
