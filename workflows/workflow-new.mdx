...
<Steps>
  <Step title="Name it" icon="font">
    Open **Workflow settings** and give the workflow a name and description. Both show up wherever the workflow is listed or offered as a button. This panel also controls overlap, maximum concurrency, and whether each run reserves its worktree.
  </Step>
