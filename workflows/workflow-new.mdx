...
<Steps>
  <Step title="Name it" icon="font">
    Open **Workflow settings** and give the workflow a name and description. Both show up wherever the workflow is listed or offered as a button. Its **Running** section also controls overlap, the [scope](/workflows/workflow-edit#overlap-scope) that overlap is measured in, and whether each run reserves its worktree.
  </Step>
