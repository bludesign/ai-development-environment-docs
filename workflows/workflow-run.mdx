...
<Tabs>
  ...
  <Tab title="Step attempts">
    One row per attempt with **Step**, **Status**, **Phase**, **Generation**, **Iteration**, **Attempt**, **Duration**, and **Error**. Phase is the scheduler's own sub-state for the attempt — including **Reused** and **Queued for replay** after a replay. Iteration distinguishes passes through a **For each** body; attempt distinguishes retries of the same step.
