...
- A draft holds a reference to a worktree, not a lease on it. If that worktree is gone or busy by the time you start, the [new run](/ai/run-new) page tells you before anything is created.
