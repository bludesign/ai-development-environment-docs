...
Rows are grouped by the day the run was created, with anything still active pulled into a leading **Active** group so in-flight work stays at the top.

| Column | What it shows |
| --- | --- |
| ID | `#1234`, the Plan's display number. Links to the [detail page](/ai/plan-detail) |
| Status | **In progress**, **Paused**, **Completed**, **Cancelled**, or **Failed**, plus a phase badge when the phase differs from the status |
...
- Plans do not take an exclusive worktree lease, so several Plans can survey the same worktree at once. Sessions do.
