...
The iOS app presents the same order and actions with native sheets. Its Follow Up form also supports attachments, eligible MCP presets, provider defaults, cross-provider context, and paused-Session transfer confirmation, then opens the created child run.
