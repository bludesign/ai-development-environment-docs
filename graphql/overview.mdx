...
Control agents on managed Macs connect outbound to the WebSocket port and never expose a listening port of their own. See [Development](/reference/development) for the environment variables that move those ports.
