...
Apps post crash reports and CI posts debug symbols here. See [Crashes](/debugging/crashes#send-crashes-from-your-app) and [dSYMs](/debugging/dsyms#upload-from-ci) for full examples.
