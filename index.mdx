...
- Long-lived Jira, GitHub, signing, and APNs secrets go through a server-only [credential service](/system/credentials) backed by the database, HashiCorp Vault, or the macOS Keychain.
