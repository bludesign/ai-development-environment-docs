...
<Columns cols={2}>
  <Card title="Plan" icon="clipboard-list" href="/ai/plans">
    A read-only codebase survey. Appears while it is **In progress** or **Paused**, and after it **fails**.
  </Card>
  <Card title="Session" icon="comments" href="/ai/sessions">
    An AI run that edits a worktree. Same rule as Plans — in progress, paused, or failed.
  </Card>
...
| Active | Green | Work is in progress and needs nothing from you. |
...
<Columns cols={2}>
  <Card title="Notifications" icon="bell" href="/notifications">
    Route the same events to the sidebar, browser alerts, or Web Push.
  </Card>
