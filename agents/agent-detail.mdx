---
title: "Agent details"
description: "Inspect one enrolled machine's hardware, capabilities, codebases, and jobs."
---
...
Recent macOS agents also advertise worktree-independent run-destination inspection, resumable artifact upload, and remote app deployment. These capabilities let a build produced on one Mac run on a simulator or physical device connected to another Mac. They do not copy the repository and do not expose an inbound listener on either agent.
